...
# Load a ppiretrained model from the trained folder
...
cv2.imwrite("example.png", model.draw(image, poses, lms, bbox, draw_face=True, draw_person=True, draw_axis=True))
cv2.waitKey(0)